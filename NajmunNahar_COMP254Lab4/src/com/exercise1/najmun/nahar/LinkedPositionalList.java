...
public static void main(String[] args) {
		...
		Position<String> p1 = l1.addFirst("Mon");				// addFirst
		l1.addLast("Wed");										// addLast
		l1.addBetween("Tue", (Node<String>) p1, l1.header.next.next); // addBetween


		System.out.println("l1: " + l1.toString());

		// findPosition(e); String
		String str = "Mon";      // string to find for position
		Position<String> findPositionByString = l1.findPosition(str);

		if (findPositionByString != null) {
			System.out.println("Position found: " + findPositionByString.getElement());
		} else {
			System.out.println("Position of " + str+ " not found!!");
		}
