...
public class TreeMap<K,V> extends AbstractSortedMap<K,V> {
  ...
  */
  ...
  public static void main (String[] args)
  {
	  ...
	  // treeSearch starting from root
	  Position<Entry<Integer, String>> mapFound = map.treeSearch(map.root(), 4);
	  
	  if (mapFound.getElement() != null) {
		  System.out.println("Key 4 found -> " + mapFound.getElement());
	  }
	  else {
	...
	// treeSearchLoop starting from root
	  Position<Entry<Integer, String>> mapFound2 = map.treeSearch(map.root(), 10);

	  if (mapFound2.getElement()!= null) {
		  System.out.println("Key 10 found -> " + mapFound2.getElement());
	  }
	  else {
